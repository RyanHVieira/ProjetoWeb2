      ...
      <div className="auth-box">
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            <label>Usuário</label>
            <input type="text" placeholder="Escolha um nome de usuário" value={username} onChange={(e) => setUsername(e.target.value)} required/>
          </div>
        ...
        <div className="auth-link">Já possui uma conta? <a href="/login">Entrar</a></div>
      </div>
    </div>
  );
}
